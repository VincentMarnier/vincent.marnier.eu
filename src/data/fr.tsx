...
export const jobs = [
  ...
  },
  {
    ...
    description: <>
      Lead dev d&apos;une plateforme d&apos;acquisition de données IT/OT pour l&apos;infrastructure edge de Schneider Electric.
      <ul style={{ margin: "4px 0", paddingLeft: "1.5em" }}>
...
export const projectsAndContributions = [
  ...
  },
  {
    ...
    color: "#000000",
    description: "Portage Rust assisté par IA et évolution du proxy de sécurisation Jedi Academy, adressant les vulnérabilités réseau via interposition de module, function detouring et injection.",
